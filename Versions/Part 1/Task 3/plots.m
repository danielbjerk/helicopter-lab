...
%% Init
input = load('p1t3_w0=pi-over-2-zeta=1_p-c-and-p.mat');
plot_title = 'PD pitch controller, adjusting \zeta and \omgea_0, manual input, \zeta = 1, \omega_0 = pi/2';
file_name = 'p1t3_w0=pi-over-2-zeta=1_p-c-and-p';
xaxis = 'Time [s]';
yaxis = 'Pitch [rad]';

time = input.ans(1,:);
reference = input.ans(2,:);
values = input.ans(3,:);
