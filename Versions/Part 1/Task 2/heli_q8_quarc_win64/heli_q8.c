 ...
 * C source code generated on : Sat Aug 29 16:53:02 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S3>/Sum'
     */
    heli_q8_B.ElevationCounttorad = (rtb_DeadZoney -
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    rtb_Backgain = heli_q8_P.Step_Y0;
  } else {
    rtb_Backgain = heli_q8_P.Step_YFinal;
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Backgain - heli_q8_B.Constant) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain + heli_q8_B.Constant) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3539309626U);
  heli_q8_M->Sizes.checksums[1] = (4131668287U);
  heli_q8_M->Sizes.checksums[2] = (3258355383U);
  heli_q8_M->Sizes.checksums[3] = (728836086U);
