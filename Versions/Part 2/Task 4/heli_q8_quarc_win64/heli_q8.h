...
typedef struct {
  real_T Constant[10];                 /* '<S4>/Constant' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Elevation_PWORK;                   /* '<S4>/Elevation' */

  struct {
    void *LoggedData;
  } Elevationrate_PWORK;               /* '<S4>/Elevation rate' */

  struct {
    void *LoggedData;
  } Pitch_PWORK;                       /* '<S4>/Pitch' */
 ...
 * '<S4>'   : 'heli_q8/Subsystem'
 * '<S5>'   : 'heli_q8/Reference values/Joystick'
 * '<S6>'   : 'heli_q8/Reference values/Ramp'
 */
