...
%% Init
input = load('p2t3_LQR-tuning-40-1-100,0,1-1_e-dot-c-and-e-dot.mat');
plot_title = 'LQR tuning elevation rate';
file_name = 'p2t3_LQR-tuning-R-1vs0,1_e-dot-and-e-dot-c';
xaxis = 'Time [s]';
...
%   
legend('Reference', 'Measured value, R = 1', 'Measured value, R = 0.1'); 
