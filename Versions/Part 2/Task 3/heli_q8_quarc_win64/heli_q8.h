...
typedef struct {
  ...
  } TransportDelay2_RWORK;             /* '<S3>/Transport Delay2' */
  ...
  struct {
    void *TUbufferPtrs[2];
  } TransportDelay2_PWORK;             /* '<S3>/Transport Delay2' */
  ...
  } TransportDelay2_IWORK;             /* '<S3>/Transport Delay2' */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Reference values'
 * '<S4>'   : 'heli_q8/Reference values/Joystick'
 * '<S5>'   : 'heli_q8/Reference values/Ramp'
 */
