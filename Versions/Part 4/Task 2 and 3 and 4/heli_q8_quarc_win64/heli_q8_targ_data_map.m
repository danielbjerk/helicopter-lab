  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% heli_q8_B.TmpSignalConversionAtToFile6Inp
	  section.data(12).logicalSrcIdx = 11;
	  ...
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 98;
	  ...
	  section.data(39).dtTransOffset = 156;
	
	  ;% heli_q8_B.Joystick_gain_x
	  section.data(40).logicalSrcIdx = 39;
	  section.data(40).dtTransOffset = 157;
	  ...
	  section.data(43).dtTransOffset = 160;
	  ...
	  section.data(45).dtTransOffset = 168;
	
	  ;% heli_q8_B.P_pred_k_plus_1
	  section.data(46).logicalSrcIdx = 45;
	  section.data(46).dtTransOffset = 198;
	
	  ;% heli_q8_B.x_pred_k_plus_1
	  section.data(47).logicalSrcIdx = 46;
	  section.data(47).dtTransOffset = 234;
	  ...
	  section.data(49).dtTransOffset = 246;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.ToFile_PWORK_l.FilePtr
	  section.data(32).logicalSrcIdx = 51;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_q8_DW.ToFile1_PWORK_o.FilePtr
	  section.data(33).logicalSrcIdx = 52;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_q8_DW.ToFile2_PWORK_b.FilePtr
	  ...
	  ;% heli_q8_DW.ToFile_IWORK_f.Count
	  section.data(8).logicalSrcIdx = 71;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_q8_DW.ToFile1_IWORK_h.Count
	  section.data(9).logicalSrcIdx = 72;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_DW.ToFile2_IWORK_f.Count
  ...
  targMap.checksum0 = 3920341739;
  targMap.checksum1 = 1166733727;
  targMap.checksum2 = 1310884468;
  targMap.checksum3 = 3881155796;
