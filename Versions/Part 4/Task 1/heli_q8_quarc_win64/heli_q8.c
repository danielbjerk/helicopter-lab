 ...
 * C source code generated on : Tue Nov 03 12:12:13 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   */
  /* MATLAB Function 'Measurement transformations/Accelerometer values to euler angles corrected': '<S16>:1' */
  /* '<S16>:1:3' */
  /* '<S16>:1:4' */
  /* '<S16>:1:5' */
  /* '<S16>:1:7' */
  ...
  /* MATLAB Function 'Measurement transformations/Gyro vector to [pitch rate, elevation rate, travle rate]': '<S17>:1' */
  /* '<S17>:1:3' */
  /* '<S17>:1:4' */
  /* psi = euler_angles(3); */
  /* '<S17>:1:8' */
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step1_Time) {
    x_out = heli_q8_P.Step1_Y0;
  } else {
    x_out = heli_q8_P.Step1_YFinal;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  UnitDelay: '<S7>/Unit Delay1'
     */
    /* MATLAB Function 'Kalman filter/Update weighting': '<S15>:1' */
    /* '<S15>:1:2' */
    for (i = 0; i < 5; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        tmp_2[i + 5 * i_0] = 0.0;
  ...
  /* Switch: '<S6>/Switch1' */
  if (x_out > heli_q8_P.Switch1_Threshold) {
    ...
    heli_q8_B.Switch1[3] = rtb_euler_rates[1];
    heli_q8_B.Switch1[4] = rtb_euler_rates[2];
  } else {
    heli_q8_B.Switch1[0] = heli_q8_B.Constant1;
    heli_q8_B.Switch1[1] = heli_q8_B.Constant1;
    heli_q8_B.Switch1[2] = heli_q8_B.Constant1;
    heli_q8_B.Switch1[3] = heli_q8_B.Constant1;
    heli_q8_B.Switch1[4] = heli_q8_B.Constant1;
  }

  /* End of Switch: '<S6>/Switch1' */

  /* MATLAB Function: '<S7>/Correction step' */
  /* MATLAB Function 'Kalman filter/Correction step': '<S11>:1' */
  if (!heli_q8_B.StreamRead1_o3) {
    /* '<S11>:1:3' */
    /* '<S11>:1:4' */
    for (i = 0; i < 6; i++) {
    ...
    for (i = 0; i < 5; i++) {
      ...
      tmp_3[i] = heli_q8_B.Switch1[i] - a_c;
    }

    for (i = 0; i < 6; i++) {
      a_c = 0.0;
      for (i_0 = 0; i_0 < 5; i_0++) {
        a_c += heli_q8_B.K_k[6 * i_0 + i] * tmp_3[i_0];
      }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToFileInpo[0] = heli_q8_B.Switch1[0];
    heli_q8_B.TmpSignalConversionAtToFileInpo[1] = heli_q8_B.x_est_k[0];
    heli_q8_B.TmpSignalConversionAtToFileInpo[2] = heli_q8_B.x_est_k[1];
    heli_q8_B.TmpSignalConversionAtToFileInpo[3] = heli_q8_B.PitchCounttorad;
        ...
        if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 5, fp) != 5) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file p4t3_testing-kalman_Qd-0_p.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile_IWORK.Count)*5)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    allowed in MAT-file p4t3_testing-kalman_Qd-0_p.mat.\n");
            }
          }
        }
      }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* End of RateTransition: '<S18>/Rate Transition: y' */
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    memcpy(&heli_q8_B.Constant[0], &heli_q8_P.K[0], 10U * sizeof(real_T));
  ...
  if (a_c > heli_q8_P.Switch1_Threshold_k) {
     ...
     */
    tmp_4[0] = heli_q8_B.PitchCounttorad;
    tmp_4[1] = heli_q8_B.PitchTransferFcn;
    tmp_4[2] = heli_q8_B.ElevationTransferFcn;
    tmp_4[3] = heli_q8_X.Integrator_CSTATE;
    ...
    for (i = 0; i < 2; i++) {
       ...
       */
      tmp_5[i] = 0.0;
      tmp_5[i] += heli_q8_B.Constant1_j[i] * heli_q8_B.TransferFcn_d;
      tmp_5[i] += heli_q8_B.Constant1_j[i + 2] * heli_q8_B.Joystick_gain_y;
      ...
      tmp_6[i] = 0.0;
      for (i_0 = 0; i_0 < 5; i_0++) {
        tmp_6[i] += heli_q8_B.Constant[(i_0 << 1) + i] * tmp_4[i_0];
      }

      /* End of Product: '<S1>/Product' */

      /* Sum: '<S1>/Sum1' */
      rtb_Sum1[i] = tmp_5[i] - tmp_6[i];
    }
  ...
  /* MATLAB Function 'Kalman filter/Prediction step': '<S12>:1' */
  /* '<S12>:1:3' */
  for (i = 0; i < 6; i++) {
    tmp_7[i] = 0.0;
    for (i_0 = 0; i_0 < 6; i_0++) {
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    /* MATLAB Function 'Kalman filter/Update estimate variance': '<S13>:1' */
    if (!heli_q8_B.StreamRead1_o3) {
      /* '<S13>:1:3' */
      /* '<S13>:1:4' */
     ...
     */
    /* MATLAB Function 'Kalman filter/Update prediction variance': '<S14>:1' */
    /* '<S14>:1:3' */
    for (i = 0; i < 6; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        tmp_9[i + 6 * i_0] = 0.0;
    ...
    for (i = 0; i < 6; i++) {
      for (i_0 = 0; i_0 < 6; i_0++) {
        a_c = 0.0;
        for (i_1 = 0; i_1 < 6; i_1++) {
          a_c += tmp_9[6 * i_1 + i] * heli_q8_P.A_d[6 * i_1 + i_0];
        }
...
{
  /* Update for RateTransition: '<S18>/Rate Transition: y' */
  heli_q8_DW.RateTransitiony_Buffer0 = heli_q8_B.GameController_o5;

  /* Update for RateTransition: '<S18>/Rate Transition: x' */
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "p4t3_testing-kalman_Qd-0_p.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file p4t3_testing-kalman_Qd-0_p.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,5,0,"ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file p4t3_testing-kalman_Qd-0_p.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file p4t3_testing-kalman_Qd-0_p.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file p4t3_testing-kalman_Qd-0_p.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 5, heli_q8_DW.ToFile_IWORK.Count, "ans")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file p4t3_testing-kalman_Qd-0_p.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3718490825U);
  heli_q8_M->Sizes.checksums[1] = (1973540446U);
  heli_q8_M->Sizes.checksums[2] = (977726706U);
  heli_q8_M->Sizes.checksums[3] = (3934888892U);
