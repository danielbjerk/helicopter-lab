...
typedef struct {
  ...
  real_T Constant4;                    /* '<S4>/Constant4' */
  real_T Sum2;                         /* '<S4>/Sum2' */
  real_T Switch_p;                     /* '<S4>/Switch' */
  real_T Constant_o;                   /* '<S10>/Constant' */
  real_T Constant1;                    /* '<S10>/Constant1' */
  real_T Sum1;                         /* '<S4>/Sum1' */
  ...
  real_T Integrator2[2];               /* '<S5>/Integrator2' */
...
typedef struct {
  ...
  struct {
    real_T modelTStart;
    real_T TUbufferArea[2048];
  } TransportDelay2_RWORK;             /* '<S4>/Transport Delay2' */
  ...
  struct {
    void *TUbufferPtrs[2];
  } TransportDelay2_PWORK;             /* '<S4>/Transport Delay2' */
  ...
  struct {
    void *LoggedData;
  } Elevationrate_PWORK_d;             /* '<S5>/Elevation rate' */
  ...
  int32_T clockTickCounter_d;          /* '<S4>/Pulse Generator1' */
  ...
  struct {
    ...
    int_T Last;
    int_T CircularBufSize;
  } TransportDelay2_IWORK;             /* '<S4>/Transport Delay2' */
...
typedef struct {
  ...
  real_T Integrator2_CSTATE[2];        /* '<S5>/Integrator2' */
  real_T TransferFcn_CSTATE_p;         /* '<S5>/Transfer Fcn' */
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE[2];     /* '<S5>/Integrator2' */
  boolean_T TransferFcn_CSTATE_p;      /* '<S5>/Transfer Fcn' */
...
struct P_heli_q8_T_ {
  ...
  real_T Step_Y0_i;                    /* Expression: 0
                                        * Referenced by: '<S10>/Step'
                                        */
  real_T Step_Time_k;                  /* Expression: 30
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/IMU'
 * '<S4>'   : 'heli_q8/Reference values'
 * '<S5>'   : 'heli_q8/Subsystem'
 * '<S6>'   : 'heli_q8/IMU/Accelerometer values to euler angles'
 * '<S7>'   : 'heli_q8/IMU/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S8>'   : 'heli_q8/IMU/IMU'
 * '<S9>'   : 'heli_q8/Reference values/Joystick'
 * '<S10>'  : 'heli_q8/Reference values/Ramp'
 */
