...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      heli_q8_B.euler_rates[i] += tmp[i] * tmp_0[0];
      heli_q8_B.euler_rates[i] += tmp[i + 3] * tmp_0[1];
      heli_q8_B.euler_rates[i] += tmp[i + 6] * tmp_0[2];
    }

    /* MATLAB Function: '<S6>/Accelerometer values to euler angles corrected' incorporates:
     *  Memory: '<S6>/Memory2'
     */
    /* MATLAB Function 'Measurement transformations/Accelerometer values to euler angles corrected': '<S10>:1' */
    /* '<S10>:1:3' */
    /* '<S10>:1:4' */
    /* '<S10>:1:5' */
    /* '<S10>:1:7' */
    /* '<S10>:1:8' */
    a_c = heli_q8_B.euler_rates[2] * heli_q8_B.euler_rates[2] * 0.66;
    if (rtb_Gain2[2] == 0.0) {
      /* '<S10>:1:10' */
      /* '<S10>:1:11' */
      x_out = 0.0;
      ...
      /* '<S10>:1:13' */
      x_out = atan(rtb_Gain2[1] / rtb_Gain2[2]);
    }

    if ((a_c * sin(heli_q8_DW.Memory2_PreviousInput) + rtb_Gain2[2]) +
        rtb_Gain2[1] * rtb_Gain2[1] == 0.0) {
      /* '<S10>:1:16' */
      /* '<S10>:1:17' */
      a_c = 0.0;
    } else {
      ...
      /* '<S10>:1:20' */
      a = a_c * sin(heli_q8_DW.Memory2_PreviousInput) + rtb_Gain2[2];
      a_c = atan((a_c * cos(heli_q8_DW.Memory2_PreviousInput) + rtb_Gain2[0]) /
                 sqrt(rtb_Gain2[1] * rtb_Gain2[1] + a * a));
    }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToFileInpo[0] = heli_q8_B.euler_angles[0];
        ...
        if (!(++heli_q8_DW.ToFile_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 4, fp) != 4) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file p3t4_sentripetal-acc_p.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile_IWORK.Count)*4)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    allowed in MAT-file p3t4_sentripetal-acc_p.mat.\n");
            }
          }
        }
      }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToFile1Inp[0] = heli_q8_B.euler_rates[0];
    ...
    heli_q8_B.TmpSignalConversionAtToFile2Inp[0] = heli_q8_B.euler_angles[1];
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToFile3Inp[0] = heli_q8_B.euler_rates[1];
    ...
    if (rtmIsMajorTimeStep(heli_q8_M)) {
      {
        if (!(++heli_q8_DW.ToFile3_IWORK.Decimation % 1) &&
          ...
          if (fp != (NULL)) {
            ...
            if (fwrite(u, sizeof(real_T), 4, fp) != 4) {
              rtmSetErrorStatus(heli_q8_M,
                                "Error writing to MAT-file p3t4_sentripetal-acc_e-dot.mat");
              return;
            }
            ...
            if (((++heli_q8_DW.ToFile3_IWORK.Count)*4)+1 >= 100000000) {
              (void)fprintf(stdout,
                            ...
                            "    the simulation has ended, because it has reached\n"
                            "    the maximum number of elements (100000000)\n"
                            "    allowed in MAT-file p3t4_sentripetal-acc_e-dot.mat.\n");
            }
          }
        }
      }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    heli_q8_B.TmpSignalConversionAtToFile4Inp[0] = heli_q8_B.euler_rates[2];
   ...
   */
  tmp_1[0] = heli_q8_B.PitchCounttorad;
  tmp_1[1] = heli_q8_B.PitchTransferFcn;
  tmp_1[2] = heli_q8_B.ElevationTransferFcn;
  tmp_1[3] = heli_q8_X.Integrator_CSTATE_c;
  ...
  for (i = 0; i < 2; i++) {
     ...
     */
    tmp_2[i] = 0.0;
    tmp_2[i] += heli_q8_B.Constant1[i] * heli_q8_B.TransferFcn_d;
    tmp_2[i] += heli_q8_B.Constant1[i + 2] * heli_q8_B.Joystick_gain_y;
    ...
    tmp_3[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_3[i] += heli_q8_B.Constant[(i_0 << 1) + i] * tmp_1[i_0];
    }

    /* End of Product: '<S1>/Product' */

    /* Sum: '<S1>/Sum1' */
    rtb_TmpSignalConversionAtGain1I[i] = tmp_2[i] - tmp_3[i];
  }
  ...
  /* Sum: '<Root>/Sum' */
  x_out = heli_q8_B.Vs_offset + rtb_TmpSignalConversionAtGain1I[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S2>/Add'
   */
  a_c = (x_out - rtb_TmpSignalConversionAtGain1I[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S2>/Subtract'
   */
  a_c = (x_out + rtb_TmpSignalConversionAtGain1I[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* SignalConversion: '<S8>/TmpSignal ConversionAtGain4Inport1' incorporates:
     *  Gain: '<S8>/Gain4'
     */
    tmp_4[0] = heli_q8_B.euler_angles[0];
    tmp_4[1] = heli_q8_B.euler_rates[0];
    tmp_4[2] = heli_q8_B.euler_angles[1];
    tmp_4[3] = heli_q8_B.euler_rates[1];
    tmp_4[4] = heli_q8_B.euler_rates[2];

    /* Gain: '<S8>/Gain4' */
    for (i = 0; i < 5; i++) {
      heli_q8_B.Gain4[i] = 0.0;
      for (i_0 = 0; i_0 < 5; i_0++) {
        heli_q8_B.Gain4[i] += heli_q8_P.C[5 * i_0 + i] * tmp_4[i_0];
      }
    }
  }
  ...
  for (i = 0; i < 5; i++) {
    a_c = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      a_c += heli_q8_P.C[5 * i_0 + i] * heli_q8_B.Integrator[i_0];
    }

    tmp_1[i] = heli_q8_B.Gain4[i] - a_c;
  }
  ...
  for (i = 0; i < 5; i++) {
     ...
     *  SignalConversion: '<S8>/TmpSignal ConversionAtGain1Inport1'
     *  Sum: '<S8>/Sum1'
     */
    tmp_5[i] = 0.0;
    tmp_5[i] += heli_q8_P.B[i] * x_out;
    tmp_5[i] += heli_q8_P.B[i + 5] * rtb_TmpSignalConversionAtGain1I[1];
    ...
    for (i_0 = 0; i_0 < 5; i_0++) {
       ...
       *  Sum: '<S8>/Sum1'
       */
      tmp_4[i] += heli_q8_P.L[5 * i_0 + i] * tmp_1[i_0];
    }

    /* Sum: '<S8>/Sum1' incorporates:
     *  Gain: '<S8>/Gain'
     */
    heli_q8_B.Sum1[i] = (tmp_4[i] + tmp_5[i]) + a_c;
  }
}
...
void heli_q8_initialize(void)
{
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "p3t4_sentripetal-acc_p.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file p3t4_sentripetal-acc_p.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,4,0,"ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file p3t4_sentripetal-acc_p.mat");
      return;
    }
  ...
  {
    FILE *fp = (NULL);
    char fileName[509] = "p3t4_sentripetal-acc_e-dot.mat";
    if ((fp = fopen(fileName, "wb")) == (NULL)) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error creating .mat file p3t4_sentripetal-acc_e-dot.mat");
      return;
    }

    if (rt_WriteMat4FileHeader(fp,4,0,"ans")) {
      rtmSetErrorStatus(heli_q8_M,
                        "Error writing mat file header to file p3t4_sentripetal-acc_e-dot.mat");
      return;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file p3t4_sentripetal-acc_p.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file p3t4_sentripetal-acc_p.mat");
        return;
      }

      if (rt_WriteMat4FileHeader(fp, 4, heli_q8_DW.ToFile_IWORK.Count, "ans")) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file p3t4_sentripetal-acc_p.mat");
      }
  ...
  /* Terminate for ToFile: '<Root>/To File3' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (fclose(fp) == EOF) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error closing MAT-file p3t4_sentripetal-acc_e-dot.mat");
        return;
      }

      if ((fp = fopen(fileName, "r+b")) == (NULL)) {
        rtmSetErrorStatus(heli_q8_M,
                          "Error reopening MAT-file p3t4_sentripetal-acc_e-dot.mat");
        return;
      }
      ...
      {
        rtmSetErrorStatus(heli_q8_M,
                          "Error writing header for ans to MAT-file p3t4_sentripetal-acc_e-dot.mat");
      }
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1284994459U);
  heli_q8_M->Sizes.checksums[1] = (2753195354U);
  heli_q8_M->Sizes.checksums[2] = (176316170U);
  heli_q8_M->Sizes.checksums[3] = (1289510260U);
  ...
  heli_q8_M->Sizes.numBlockPrms = (536);/* Sum of parameter "widths" */
  return heli_q8_M;
}
